...
/**
 * Responsible on pattern matching a path
 * @author amitport
 */
public abstract class Matcher implements Serializable {
	 ...
	 * @return a matcher that is responsible on matching the rest of the pattern
	 */
	...
	/**
	 * matches two alternative in the same time
	 * @author amitport
	 */
	...
	/**
	 * used to pair two matcher together, this is vital for making sequences
	 * @author amitport
	 */
